...
(function () { 
  ...
  */
  QBasic.VirtualMachine = function(cons) {
    // Stack
    this.stack = [];
  ...
  QBasic.VirtualMachine.prototype = {
    ...
    */
    ...
    runSome: function () {
      var start = Date.now();
      // TODO(max99x): Decide whether we need the try-catch block.
      //try {
      for (var i = 0; i < this.instructionsPerInterval &&
      ...
      // TODO(max99x): Find out WTF this is.
      /*
        ...
        if ( Math.random() < 0.2 ) {
            console.log("actualTime: " + actualTime +
                        " InstructionsPerInterval=" +
                        this.instructionsPerInterval);
        }
      */
    },
