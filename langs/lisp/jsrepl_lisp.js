...
JSREPL.Engines.Lisp.Init = function(input_func,
																			...
																			result_func,
																			error_func){
	//TODO(amasad):Use a seperate file to do this shit, consider loading script with type "text/lisp"
	//place in, out methods in global dummy object
	window.dummy = {
		input: input_func,
		output: output_func
	};
...
'(defun map (F L) (if (null L) Nil (cons (F (head L)) (map F (tail L)))))',
	...
	//TODO(amasd):implement Math functions
console.log('x');
	delete window.dummy
